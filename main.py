...
st.set_page_config(page_title="TRX Simple Strategy", layout="wide")

# ၁။ Betting Rules (Skip မရှိတော့ဘဲ ပုံမှန်အတိုင်း ပြန်ပြင်ထားသည်)
special_pats = {"BSSS": "S", "SSSB": "B", "SBBB": "S", "BBBS": "B"}
normal_pats = {
    "BBSS": "B", "SSBB": "B", "BSBS": "B", "SBSB": "S",
    "BSSB": "B", "SBBS": "S", "BBSB": "S", "SSBS": "B",
    "BSBB": "S", "SBSS": "S",
    "BBBB": "B", "SSSS": "S" # အရင်က Skip တာတွေကိုပါ ပုံမှန်ပြန်ထည့်ထားသည်
}
...
st.title("🎯 TRX Strategy Dashboard")
...
with st.sidebar:
    ...
    st.write("၁။ Pattern ရိုက်ထည့်ပြီး Prediction ယူပါ။")
    st.write("၂။ ရလဒ်အလိုက် W သို့မဟုတ် L ကို နှိပ်ပြီး History မှတ်ပါ။")
